...
export const allProjects: Project[] = [
  {
    ...
    shortDescription:
      "A comprehensive ERP solution managing accounting, HR, and inventory with real-time analytics and role-based access control.",
    detailedDescription:
  ...
  },
  {
    ...
    shortDescription:
      "A high-traffic platform calculating vehicle depreciation and market value based on live aggregated data points.",
    detailedDescription:
  ...
  },
  {
    ...
    shortDescription:
      "High-density management interface designed to eliminate scroll fatigue while surfacing critical KPIs.",
    detailedDescription:
  ...
  },
  {
    ...
    shortDescription:
      "A custom billing engine processing thousands of transactions securely with strict ACID compliance.",
    detailedDescription:
  ...
  },
  {
    ...
    shortDescription:
      "A headless e-commerce frontend delivering sub-second page loads and an optimized checkout flow.",
    detailedDescription:
  ...
  },
  {
    ...
    category: "Websockets",
    shortDescription:
      "A scalable real-time messaging application with presence indicators and typing notifications.",
    detailedDescription:
  ...
  },
  {
    ...
    category: "Mobile App",
    shortDescription:
      "A fleet tracking application for delivery drivers providing live GPS updates and route optimization.",
    detailedDescription:
  ...
  },
  {
    ...
    category: "Full Stack",
    shortDescription:
      "A secure patient portal complying with HIPAA regulations, offering telehealth integrations.",
    detailedDescription:
